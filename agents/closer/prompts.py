...
⚠️ **El cierre NO usa tools de pago**. El cierre se hace enviando el link directo al checkout: `https://msklatam.com/checkout/{{slug}}/?utm_source=bot`. El usuario completa sus datos y abona ahí.
